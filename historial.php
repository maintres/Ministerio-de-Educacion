...
require 'navbar.php';
$dni = $_GET['dni'];
function obtenerDatosProfesores($db,$dni)
    {
        $query = "SELECT 
                    hs_catedras.*, 
                    profesor.*,
            ...
            <div class="card rounded-2 border-0">
                <div class="card-header bg-dark text-white pb-0">
                    ...
                    <div class="dropdown float-right mb-2">
                        ...
                        <div id="headerDropdown" class="dropdown-menu">
                            <a href="hs_catedra_crea.php?dni=<?php echo $dni;?>">Horas Catedra</a>
                ...
                <div class="card-body table-responsive" style="background-color: #cccccc;">
                    <table id="example" class="table  table-striped table-hover table-sm  pb-4" style="width:100%">
                        ...
                        <tbody >
                            <?php
                            $profesores = obtenerDatosProfesores($db,$dni);
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo htmlspecialchars($profesor['nombre_tabla'] ?? '', ENT_QUOTES, 'UTF-8'); ?>
